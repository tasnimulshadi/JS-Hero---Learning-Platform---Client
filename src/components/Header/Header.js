        ...
        <header className="p-4 bg-gray-800 text-gray-100">
            <div className="container flex justify-between h-16 mx-auto">
                <Link to="/" className="flex items-center p-2">
                    <h2 className='text-2xl font-semibold'><span className='text-amber-500 font-extrabold text-3xl'>JS</span>hero</h2>
                </Link>
                <ul className="items-stretch hidden space-x-3 lg:flex">
                    ...
                    <li className="flex">
                        <NavLink to="/courses" className={activeNav}>Courses</NavLink>
                    </li>
                    <li className="flex">
            ...
            <div className={`lg:hidden mb-4 ${dropMenu ? 'block' : 'hidden'}`}>
                <ul className='flex flex-col gap-4 items-center'>
                    ...
                    </button>
                    {
                        user ?
                            ...
                            :
                            <button className="self-center px-8  rounded">Sign in</button>
                    }
                </ul>
