    ...
    return (
        <section className="dark:bg-gray-800 dark:text-gray-100">
            <div className="container mx-auto flex flex-col p-6">
                <h2 className="py-4 text-3xl font-bold text-center">Learn practical JavaScript</h2>
                <div className="divide-y divide-gray-700">
                    <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
                        <div className="flex items-center justify-center lg:col-span-1 col-span-full">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#818cf8" className="w-16 h-16">
                        ...
                        <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                            <span className="text-xl font-bold md:text-2xl">Video Tutorials</span>
                            <span className="mt-4 dark:text-gray-300">This complete JavaScript tutorial for beginners will teach you everything you need to know.</span>
                        </div>
                    </div>
                    <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
                        <div className="flex items-center justify-center lg:col-span-1 col-span-full">
                        ...
                        <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                            <span className="text-xl font-bold md:text-2xl">Offline Documentation</span>
                            <span className="mt-4 dark:text-gray-300">Documentation pdf for every tutorial for better practice. Code workflow, whether you watch video or read documentation, you use JShero ultimate</span>
                        </div>
                    </div>
                    <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
                        <div className="flex items-center justify-center lg:col-span-1 col-span-full">
                        ...
                        <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                            <span className="text-xl font-bold md:text-2xl">Real life examples</span>
                            <span className="mt-4 dark:bg-gray-800 dark:text-gray-300">Web Design for Beginners: Real World Coding in JavaScript. Launch a career as a web developer by learning JavaScript</span>
                        </div>
                    </div>
                    <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
                        <div className="flex items-center justify-center lg:col-span-1 col-span-full">
                        ...
                        <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                            <span className="text-xl font-bold md:text-2xl">Practice Code</span>
                            <span className="mt-4 dark:text-gray-300">Choose your own coding adventure. Need a route through this practical guide? Use this map to decide the best content for you to work through.</span>
                        </div>
                    </div>
                </div>
            </div>
